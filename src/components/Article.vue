      ...
      >
        ...
        >
          <div class="md:w-[350px]">
            ...
            <p class="mb-2 md:mb-4 text-lg">
              {{ item.content }}
            </p>
            <a href="" class="text-primary font-semibold">查看更多</a>
          </div>
        </div>
        <img
          :src="item.img"
